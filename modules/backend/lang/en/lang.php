...
return [
    ...
    'list' => [
        ...
        'updating' => 'Updating...',
        'loading' => 'Loading...',
        'setup_title' => 'Настройки просмотра',
        'setup_help' => 'Используйте чекбоксы чтобы выбрать колонки необходимые для отображения. Вы можете изменить порядок отображения простым перетаскиванием вверх или вниз.',
        ...
        'delete_selected_success' => 'Успешно удалено',
    ...
    'form' => [
        ...
        'confirm_delete_multiple' => 'Вы уверены?',
